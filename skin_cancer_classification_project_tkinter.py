...
def imageResize(img):
    ...
    img = img.resize((basewidth,hsize),Image.ANTIALIAS)  #resize isleminden sonra araları doldurur
    return img
...
def openImage():
    ...
    if count !=1:
        ...
        img_name = filedialog.askopenfilename(initialdir = "C:/Users/asus_/Documents/Projects",title="Select an image file")
